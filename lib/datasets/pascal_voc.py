...
class pascal_voc(imdb):
  def __init__(self, split, year, dataset, use_diff=False):
    ...
    if dataset == 'mbari_seq0':
      self._classes = ('__background__',  # always index 0
                      'NonLiving', 'Scorpaeniformes', 'Pleuronectiformes', 'Echinodermata', 'Gadiformes',
                      'Perciformes', 'Animalia', 'Aplousobranchia', 'Carcharhiniformes', 'Cephalopoda',
                      'Chordata', 'Decapoda', 'Fish', 'Gastropoda', 'Mollusca', 'NotPleuronectiformes',
                      'Osmeriformes', 'Osteroida', 'Physical', 'Rajiformes', 'ignore')
    elif dataset == 'mouss_seq1':
      self._classes = ('__background__',  # always index 0
    ...
    elif dataset == 'mouss_seq0':
      self._classes = ('__background__',  # always index 0
                       'Carcharhiniformes', 'Animalia', 'Aplousobranchia', 'Cephalopoda', 'Chordata', 'Decapoda', 
                       'Echinodermata', 'Fish', 'Gadiformes', 'Gastropoda', 'Mollusca', 'NonLiving', 'NotPleuronectiformes',
                       'Osmeriformes', 'Osteroida', 'Perciformes', 'Physical', 'Pleuronectiformes', 'Rajiformes',
                       'Scorpaeniformes', 'ignore') 
    elif dataset == 'habcam_seq0':
  ...
  def _get_voc_results_file_template(self):
    ...
    filename = self._get_comp_id() + '_det_' + self._split + '_{:s}.txt'
    path = os.path.join(
      self._devkit_path,
      'results',
      'VOC' + self._year,
